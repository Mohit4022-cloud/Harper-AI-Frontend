    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Make calls and track your conversations</p>
        </div>
      ...
      <Card>
        <CardContent className="p-12 text-center">
          ...
          <p className="text-gray-600 mb-6">
            The calling system is being integrated with Twilio. Coming soon with features like:
          </p>
